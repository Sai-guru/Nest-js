...
// this will make the User entity
    ...
    exports: [AuthService,], // this will allow us to use the AuthService in other modules, such as the PostsModule, to check user roles and permissions when creating or updating posts, and also to interact with the database through the User repository.
